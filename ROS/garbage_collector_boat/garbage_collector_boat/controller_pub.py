...
class TrajectoryPublisher(Node):
    ...
    def __init__(self):
        ...
        self.trajectory_publisher = self.create_publisher(JointTrajectory,"/manipulator_controller/joint_trajectory", 10)


    def timer_callback(self):

        # creating a point
        goal_positions_1 = [math.pi/2,0.0,0.0, math.pi]
        goal_positions_2 = [math.pi/2,-math.pi/5 ,math.pi/4, 0.0]
        ...
        joints = ['arm_base_joint', 'link_1_joint' , 'link_2_joint', 'link_3_joint']
